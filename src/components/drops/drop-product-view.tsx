...
import DropStatusBanner from "./drop-status-banner";
import DropScarcityBar from "./drop-scarcity-bar";
...
import WaitlistForm from "@/components/wishlist/waitlist-form";
...
export default function DropProductView({
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6">
      <Breadcrumbs items={[{ label: "Inicio", href: "/" }, { label: "Drops", href: "/drops" }, { label: product.name }]} />
