-- Schema Craft3d para MariaDB (generado desde Drizzle mysql-core)
-- Ejecutar en: mysql -u usuario -p < mariadb-schema.sql
-- o en MariaDB: SOURCE mariadb-schema.sql

CREATE DATABASE IF NOT EXISTS craft3d_db CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
-- USE craft3d_db; -- Ejecutar con: mysql -u usuario -p -D craft3d_db < archivo.sql
...
-- Insertar categoría 'drops' si no existe en products:
-- UPDATE products SET category = 'drops' WHERE category = 'ediciones-limitadas';
